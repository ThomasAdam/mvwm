 ...
 *
 */
void            _SetFocusWindow(MvwmWindow *fw, Bool do_allow_force_broadcast,
...
void            restore_focus_after_unmap(const MvwmWindow *fw,
...
Bool            focus_query_click_to_raise(MvwmWindow *fw, Bool is_focused,
    int context);
Bool            focus_query_click_to_focus(MvwmWindow *fw, int context);
Bool            focus_query_open_grab_focus(MvwmWindow *fw,
    MvwmWindow *focus_win);
