...
void            check_window_style_change(MvwmWindow *t, update_win *flags,
    window_style *ret_style);
void            reset_style_changes(void);
void            update_style_colorset(int colorset);
void            update_window_color_style(MvwmWindow *fw,
    window_style *style);
void            update_window_color_hi_style(MvwmWindow *fw,
    window_style *style);
void            update_icon_title_cs_style(MvwmWindow *fw,
    window_style *pstyle);
void            update_icon_title_cs_hi_style(MvwmWindow *fw,
    window_style *pstyle);
void            update_icon_background_cs_style(MvwmWindow *fw,
    window_style *pstyle);
