...
void            EWMH_GetWorkAreaIntersection(MvwmWindow *fw, int *x, int *y,
...
int             EWMH_SetIconFromWMIcon(MvwmWindow *fw, CARD32 *list, int size,
    Bool is_mini_icon);
void            EWMH_DoUpdateWmIcon(MvwmWindow *fw, Bool mini_icon,
    Bool icon);

/* ewmh_name.c */
void            EWMH_SetVisibleName(MvwmWindow *fw, Bool is_icon_name);
int             EWMH_WMName(MvwmWindow *fw, XEvent *ev, window_style *style,
    unsigned long any);
int             EWMH_WMIconName(MvwmWindow *fw, XEvent *ev,
