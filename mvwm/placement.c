...
static int __pl_minoverlap_get_next_x(const pl_arg_t *arg)
{
	...
	for (
		other_fw = Scr.MvwmRoot.next; other_fw != NULL;
...
static pl_penalty_t __pl_minoverlap_get_avoidance_penalty(
	const pl_arg_t *arg, MvwmWindow *other_fw, const rectangle *other_g)
{
	pl_penalty_t anew;
...
static void __place_get_placement_flags(
	pl_flags_t *ret_flags, MvwmWindow *fw, window_style *pstyle,
...
static void __place_handle_x_resources(
	MvwmWindow *fw, window_style *pstyle, pl_reason_t *reason)
{
	int client_argc = 0;
...
static void __explain_placement(MvwmWindow *fw, pl_reason_t *reason)
{
...
Bool setup_window_placement(
	MvwmWindow *fw, window_style *pstyle, rectangle *attr_g,
