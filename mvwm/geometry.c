...
void gravity_get_naked_geometry(
	int gravity, MvwmWindow *t, rectangle *dest_g, rectangle *orig_g)
{
	int xoff;
	int yoff;
	size_borders b;
...
void get_title_gravity_factors(
	MvwmWindow *fw, int *ret_fx, int *ret_fy)
{
	switch (GET_TITLE_DIR(fw))
	{
	case DIR_N:
...
Bool get_title_button_geometry(
	MvwmWindow *fw, rectangle *ret_g, int context)
{
	int bnum;
...
void get_title_font_size_and_offset(
	MvwmWindow *fw, direction_t title_dir,
...
void get_shaded_geometry(
	MvwmWindow *fw, rectangle *small_g, rectangle *big_g)
{
	size_borders b;
...
static void __cs_handle_aspect_ratio(
	size_rect *ret_s, MvwmWindow *fw, size_rect s, const size_rect base,
 ...
 */
void constrain_size(
	MvwmWindow *fw, const XEvent *e, int *widthp, int *heightp,
...
void gravity_constrain_size(
	int gravity, MvwmWindow *t, rectangle *rect, int flags)
{
...
void get_page_offset(
	int *ret_page_x, int *ret_page_y, MvwmWindow *fw)
{
	rectangle r;
