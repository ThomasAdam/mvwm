...
static void border_rotate_titlebar_descr(MvwmWindow *fw, titlebar_descr *td);

/* for grouping the MultiPixmap stuff */
static Bool border_mp_get_use_title_style_parts_and_geometry(
	titlebar_descr *td, MvwmPicture **pm, MvwmAcs *acs,
...
static void get_common_decorations(
	common_decorations_type *cd, MvwmWindow *t,
...
static window_parts border_get_changed_border_parts(
	MvwmWindow *fw, rectangle *old_sidebar_g, rectangle *new_sidebar_g,
	int cs)
{
...
static int border_get_parts_and_pos_to_draw(
	common_decorations_type *cd, MvwmWindow *fw,
...
static window_parts border_get_tb_parts_to_draw(
	MvwmWindow *fw, titlebar_descr *td, rectangle *old_g, rectangle *new_g,
...
static void border_get_border_gcs(
	draw_border_gcs *ret_gcs, common_decorations_type *cd, MvwmWindow *fw,
	Bool do_hilight)
{
	...
	if (transparent_gc == None && !HAS_NO_BORDER(fw) && !HAS_MWM_BORDER(fw))
	{
		...
		xgcv.plane_mask = 0;
		transparent_gc = mvwmlib_XCreateGC(
...
static void trim_border_layout(
	MvwmWindow *fw, DecorFaceStyle *borderstyle,
...
static void border_fetch_mvwm_layout(
	MvwmWindow *fw, DecorFaceStyle *borderstyle,
	border_relief_size_descr *ret_size_descr)
{
...
static void border_get_border_relief_size_descr(
	border_relief_size_descr *ret_size_descr, MvwmWindow *fw,
	Bool do_hilight)
{
	DecorFaceStyle *borderstyle;
...
static void border_get_border_marks_descr(
	common_decorations_type *cd, border_relief_descr *br, MvwmWindow *fw)
{
	int inset;
...
static void border_draw_one_border_part(
	common_decorations_type *cd, MvwmWindow *fw, rectangle *sidebar_g,
...
static void border_draw_all_border_parts(
	common_decorations_type *cd, MvwmWindow *fw, border_relief_descr *br,
	...
	ButtonState bs)
{
	...
	{
		dcd->bar_pixmaps[bs].bps = mvwm_malloc(count * sizeof(bar_pixmap));
	}
...
static Pixmap border_get_bar_pixmaps(
	...
	int cset, MvwmPicture *mp_pic, int mp_part, int stretch,
...
static void border_mp_render_into_pixmap(
	titlebar_descr *td, common_decorations_type *cd, MvwmPicture **src,
	MvwmAcs *acs, Pixel *pixels, unsigned short solid_flags,
...
static void border_mp_get_titlebar_descr(
	MvwmWindow *fw, titlebar_descr *td, DecorFace *df)
{
	DecorFace *tsdf;
	MvwmPicture **pm;
	MvwmAcs *acs;
...
static void border_mp_get_extreme_geometry(
	titlebar_descr *td, MvwmPicture **pm, MvwmAcs *acs, unsigned short sf,
...
static void border_mp_draw_mp_titlebar(
	MvwmWindow *fw, titlebar_descr *td, DecorFace *df, Pixmap dest_pix,
	Window w)
{
	MvwmPicture **pm;
	MvwmAcs *acs;
...
static void border_draw_decor_to_pixmap(
	MvwmWindow *fw, Pixmap dest_pix, Window w,
...
static void border_set_button_pixmap(
	MvwmWindow *fw, titlebar_descr *td, int button, Pixmap *dest_pix,
	Window w)
{
	pixmap_background_type bg;
	unsigned int mask;
...
static void border_draw_one_button(
	MvwmWindow *fw, titlebar_descr *td, int button)
{
	Pixmap p;
...
static void border_draw_title_stick_lines(
	MvwmWindow *fw, titlebar_descr *td, title_draw_descr *tdd,
	Pixmap dest_pix)
{
	int i;
	int num;
...
static void border_set_title_pixmap(
	MvwmWindow *fw, titlebar_descr *td, Pixmap *dest_pix, Window w)
{
	pixmap_background_type bg;
...
static void border_draw_title(
	MvwmWindow *fw, titlebar_descr *td)
{
	Pixmap p;
...
static void border_get_titlebar_descr_state(
	MvwmWindow *fw, window_parts pressed_parts, int pressed_button,
...
void border_get_part_geometry(
	MvwmWindow *fw, window_parts part, rectangle *sidebar_g,
...
void border_draw_decorations(
	MvwmWindow *fw, window_parts draw_parts, Bool has_focus, Bool do_force,
	clear_window_parts clear_parts, rectangle *old_g, rectangle *new_g)
{
	common_decorations_type cd;
 ...
 *
 */
unsigned int border_get_transparent_decorations_part(MvwmWindow *fw)
{
	DecorFace *df,*tdf;
