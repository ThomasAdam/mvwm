...
/* If you change func_table format, change also perllib/MVWM/create-commands */
...
const func_t    func_table[] = {
	...
	/*
	 * - Bind one or another screen edge to an mvwm action
	 */

	CMD_ENT("edgeleavecommand", CMD_EdgeLeaveCommand,
	...
	CMD_ENT("ewmhbasestruts", CMD_EwmhBaseStruts, F_EWMH_BASE_STRUTS, 0,
	    0),
	/*
	...
	/*
	 * - Bind or unbind a key to an mvwm action
	 */

	CMD_ENT("killmodule", CMD_KillModule, F_KILL_MODULE, 0, 0),
	/*
	 * - Stops an mvwm module
	 */
	...
	/*
	 * - Invoke an mvwm module
	 */

	CMD_ENT("modulelistenonly", CMD_ModuleListenOnly,
	...
	/*
	 * - Modify the directories to search for an mvwm module
	 */

	CMD_ENT("modulesynchronous", CMD_ModuleSynchronous, F_MODULE_SYNC,
	    0, 0),
	/*
	 * - Invoke an mvwm module synchronously
	 */
	...
	/*
	 * - Bind or unbind a mouse button press to an mvwm action
	 */
	...
	/*
	 * - Set maximum size window mvwm should move opaquely
	 */
	...
	/*
	 * - Exec system command interpret output as mvwm commands
	 */
	...
	/*
	 * - Print information about the state of mvwm
	 */
	...
	/*
	 * - Read mvwm commands from a file
	 */
	...
	CMD_ENT("restacktransients", CMD_RestackTransients,
	    F_RESTACKTRANSIENTS,
	    FUNC_NEEDS_WINDOW, CRS_SELECT),
	/*
	...
	/*
	 * - Run an mvwm command after a delay
	 */
	...
	/*
	 * - Bind a stroke to an mvwm action
	 */
