...
DecorFace      *border_get_border_style(MvwmWindow *fw, Bool has_focus);
int             border_is_using_border_style(MvwmWindow *fw, Bool has_focus);
int             border_context_to_parts(int context);
void            border_get_part_geometry(MvwmWindow *fw, window_parts part,
    rectangle *sidebar_g, rectangle *ret_g, Window *ret_w);
int             get_button_number(int context);
void            border_draw_decorations(MvwmWindow *t,
    window_parts draw_parts, Bool has_focus, int force,
    clear_window_parts clear_parts, rectangle *old_g, rectangle *new_g);
void            border_undraw_decorations(MvwmWindow *fw);
void            border_redraw_decorations(MvwmWindow *fw);
