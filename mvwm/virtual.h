...
int             HandlePaging(XEvent *pev, int HorWarpSize, int VertWarpSize,
    int *xl, int *yt, int *delta_x, int *delta_y, Bool Grab, Bool fLoop,
...
Bool            get_page_arguments(struct monitor *, char *action,
