...
#define IS_PLACED_BY_MVWM(fw) \
	((fw)->flags.is_placed_by_mvwm)
#define SET_PLACED_BY_MVWM(fw,x) \
	(fw)->flags.is_placed_by_mvwm = (x)
#define SETM_PLACED_BY_MVWM(fw,x) \
	(fw)->flag_mask.is_placed_by_mvwm = (x)
