...
int             GetContext(FvwmWindow **ret_fw, FvwmWindow *t,
...
void            SendConfigureNotify(FvwmWindow *fw, int x, int y, int w,
...
void            events_handle_configure_request(XConfigureRequestEvent cre,
    FvwmWindow *fw, Bool force_use_grav, int force_gravity);
