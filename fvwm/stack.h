...
void            add_window_to_stack_ring_after(FvwmWindow *t,
...
Bool            position_new_window_in_stack_ring(FvwmWindow *t,
    Bool do_lower);
...
Bool            HandleUnusualStackmodes(unsigned int stack_mode,
    FvwmWindow *r, Window rw, FvwmWindow *sib, Window sibw);
...
void            mark_transient_subtree(FvwmWindow *t, int layer,
