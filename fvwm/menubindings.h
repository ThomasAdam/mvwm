 ...
 */
Binding        *menu_binding_is_mouse(XEvent *, int);
Binding        *menu_binding_is_key(XEvent *, int);
 ...
 */
void            menu_shortcuts(struct MenuRoot *,
    struct MenuParameters *, struct MenuReturn *, XEvent *,
    struct MenuItem **, double_keypress *, int *, int *);
