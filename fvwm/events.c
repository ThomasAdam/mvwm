...
static inline void
__handle_cr_on_icon(XConfigureRequestEvent * cre, FvwmWindow *fw)
{
	XWindowChanges  xwc;
	unsigned long   xwcm;
...
static inline void
__handle_cr_on_shaped(FvwmWindow *fw)
{
	/*
...
static inline void
__cr_get_grav_position(rectangle *ret_g, FvwmWindow *fw,
    XConfigureRequestEvent * cre, size_borders *b)
{
	int             grav_x;
	int             grav_y;
...
static inline void
__cr_detect_icccm_move(FvwmWindow *fw, XConfigureRequestEvent * cre,
    size_borders *b)
{
	rectangle       grav_g;
	rectangle       static_g;
...
__handle_key(const evh_args_t *ea, Bool is_press)
{
	 ...
	 */
	kc = XKeysymToKeycode(dpy, fvwm_KeycodeToKeysym(dpy, te->xkey.keycode,
		0, 0));
...
void
events_handle_configure_request(XConfigureRequestEvent cre, FvwmWindow *fw,
