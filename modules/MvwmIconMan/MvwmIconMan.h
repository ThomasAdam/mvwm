/* -*-c-*- */
#ifndef IN_MVWMICONMAN_H
#define IN_MVWMICONMAN_H
...
typedef struct win_manager
{
	...
	/*
	 * .mvwm2rc options or things set as a result of options
	 */
	Resolution      res;
	Reverse         rev;
	...
	GC              shadowContext[NUM_CONTEXTS],
	    flatContext[NUM_CONTEXTS];
	...
	MvwmIconManButtonState buttonState[NUM_CONTEXTS];
