...
typedef struct MvwmPagerScreenInfo
{
	unsigned long   screen;
	int             MyDisplayWidth;	/* my copy of DisplayWidth(dpy, screen) */
	int             MyDisplayHeight;	/* my copy of DisplayHeight(dpy, screen) */

	char           *MvwmRoot;	/* the head of the mvwm window list */
	...
	char           *Hilite;	/* the mvwm window that is highlighted
...
typedef struct desk_info
{
	...
	Window          title_w;
	Window          CPagerWin;
	MvwmPicture    *bgPixmap;	/* Pixmap used as background. */
...
void            process_message(MvwmPacket *);
