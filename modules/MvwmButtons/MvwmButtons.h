...
#define DEBUG_HANGON	/* Debug hangon, swallow and unswallow */
			    /* #define DEBUG_EVENTS *//*
			     * Get much info on events
			     */
#define DEBUG_MVWM	/* Debug communciation with mvwm */
/* #define DEBUG_X       */
#endif
...
/* ---------------------------- compatibility ------------------------------ */
			   ...
			   /*#define OLD_EXPOSE*//*
			    * Try this if resizing/exposes screw up
			    */
...
typedef struct
{
	...
	unsigned        b_Action:1;	/* Mvwm action when clicked on */
...
#define b_MvwmModule  0x0100	/* consider the swallowed app as module */
...
struct container_info_struct
{
	...
	MvwmPicture    *backicon;	/* b_Back && b_IconBack */
...
struct button_info_struct
{
	 ...
	 * conditional fields
	 *//*
	 * applicable if these flags are set
	 */
	char           *id;	/* b_Id */
	FlocaleFont    *Ffont;	/* b_Font */
	char           *font_string;	/* b_Font */
	...
	Pixel           bc, hc, sc;	/* b_Back && !b_IconBack */
	ushort          minx, miny;	/* b_Size */
	MvwmPicture    *icon;	/* b_Icon */
	MvwmPicture    *backicon;	/* b_Back && b_IconBack */
	MvwmPicture    *activeicon;	/* b_ActiveIcon */
	MvwmPicture    *pressicon;	/* b_PressIcon */
	int             activeColorset;	/* b_ActiveColorset */
	int             pressColorset;	/* b_PressColorset */
...
void            change_swallowed_window_colorset(button_info *b,
    Bool do_clear);
