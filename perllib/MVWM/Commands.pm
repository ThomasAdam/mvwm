# Autogenerated from the mvwm sources.

package MVWM::Commands;
...
@LIST = (
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Bind one or another screen edge to an mvwm action},
	},
	{
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Bind or unbind a key to an mvwm action},
	},
	{
		name => 'KillModule',
		cursor => '',
		window => 0,
		descr => q{Stops an mvwm module},
	},
	{
		name => 'Layer',
		cursor => 'SELECT',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Modify the directories to search for an mvwm module},
	},
	{
		name => 'ModuleSynchronous',
		cursor => '',
		window => 0,
		descr => q{Invoke an mvwm module synchronously},
	},
	{
		name => 'ModuleTimeout',
		cursor => '',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Bind or unbind a mouse button press to an mvwm action},
	},
	{
		name => 'Move',
		cursor => 'MOVE',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Set maximum size window mvwm should move opaquely},
	},
	{
		name => 'Pick',
		cursor => 'SELECT',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Exec system command interpret output as mvwm commands},
	},
	{
		name => 'PixmapPath',
		cursor => '',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Print information about the state of mvwm},
	},
	{
		name => 'PropertyChange',
		cursor => '',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Ask session manager to shut down itself and mvwm},
	},
	{
		name => 'Raise',
		cursor => 'SELECT',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Read mvwm commands from a file},
	},
	{
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Cause session manager to save and shutdown mvwm},
	},
	{
		name => 'SaveSession',
		cursor => '',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Run an mvwm command after a delay},
	},
	{
		name => 'Scroll',
		cursor => '',
	...
	},
	{
		...
		cursor => '',
		window => 0,
		descr => q{Bind a stroke to an mvwm action},
	},
	{
		name => 'StrokeFunc',
		cursor => '',
...
MVWM::Commands - lists all available mvwm commands

=head1 DESCRIPTION

This class is autogenerated from the mvwm sources.

It may be used to get a list of all available mvwm commands including the
...
=head1 USAGE
    ...
    my $date = strftime("%d-%b-%Y", gmtime($MVWM::Commands::TIME));
    my $version = $MVWM::Commands::VERS;
    print "The recognized commands for mvwm $version as of $date:\n\n";
    foreach my $command (@MVWM::Commands::LIST) {
...
The mvwm version number at the generation time like "2.6.0" plus the info
...
Example:
    ...
    print "The mvwm command list found on your system was generated "
        . (time() - $MVWM::Commands::TIME) / 86400 . " days ago\n";
...
Example:
    ...
    @command_names = map { $_->{name} } @MVWM::Commands::LIST;
...
For more information about the commands themselves, see mvwm(1).
