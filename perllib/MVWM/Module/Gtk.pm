...
package MVWM::Module::Gtk;

use 5.004;
use strict;

use MVWM::Module::Toolkit qw(base Gtk);
...
MVWM::Module::Gtk - MVWM::Module with the GTK+ v1 widget library attached
...
The B<MVWM::Module::Gtk> class is a sub-class of B<MVWM::Module::Toolkit>
...
For more information, see L<mvwm>, L<MVWM::Module> and L<Gtk>.

See also L<MVWM::Module::Gtk2> for use with GTK+ version 2.
