...
package MVWM::Module::Tk;

use 5.004;
use strict;

use MVWM::Module::Toolkit qw(base Tk Tk::Dialog Tk::ROText);
...
sub show_debug ($$;$) {
	...
	unless (defined $top && defined $top->{Configure}) {
		...
		$self->MVWM::Module::Toolkit::show_debug($msg, $title);
		return;
	}
...
MVWM::Module::Tk - MVWM::Module with the Tk widget library attached
...
The B<MVWM::Module::Tk> class is a sub-class of B<MVWM::Module::Toolkit>
...
$module = new B<MVWM::Module::Tk> I<TopWindow> => $top, %params

Create and return an object of the B<MVWM::Module::Tk> class.
...
Other options in I<param-hash> are the same as described in L<MVWM::Module>.
...
For more information, see L<mvwm>, L<MVWM::Module> and L<Tk>.
