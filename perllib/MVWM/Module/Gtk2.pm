...
package MVWM::Module::Gtk2;

use 5.004;
use strict;

use MVWM::Module::Toolkit qw(base Gtk2 Gtk2::Helper);
...
MVWM::Module::Gtk2 - MVWM::Module with the GTK+ v2 widget library attached
...
Name this module TestModuleGtk2, make it executable and place in ModulePath:
    ...
    use MVWM::Module::Gtk2;
    Gtk2->init;

    my $module = new MVWM::Module::Gtk2(
        Debug => 2,
    );
...
The B<MVWM::Module::Gtk2> class is a sub-class of B<MVWM::Module::Toolkit>
...
For more information, see L<mvwm>, L<MVWM::Module> and L<Gtk2>.

See also L<MVWM::Module::Gtk> for use with GTK+ version 1.
