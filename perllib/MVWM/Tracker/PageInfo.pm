...
This B<MVWM::Tracker> subclass provides an information about the current
mvwm page and desk and screen dimensions. Like with all trackers, this
...
(the mvwm variable equivalents are shown on the right):
