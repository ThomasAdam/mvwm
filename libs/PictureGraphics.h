...
Pixmap          PictureBitmapToPixmap(Display *dpy, Window win, Pixmap src,
    int depth, GC gc, int src_x, int src_y, int src_w, int src_h);
 ...
 * </description>
 */
void            PGraphicsRenderPixmaps(Display *dpy, Window win,
    Pixmap pixmap, Pixmap mask, Pixmap alpha, int depth,
 ...
 * <arg>
 */
void            PGraphicsRenderPicture(Display *dpy, Window win,
    MvwmPicture *p, MvwmRenderAttributes * fra, Drawable d, GC gc, GC mono_gc,
    GC alpha_gc, int src_x, int src_y, int src_w, int src_h, int dest_x,
    int dest_y, int dest_w, int dest_h, int do_repeat);
...
void            PGraphicsCopyPixmaps(Display *dpy, Pixmap pixmap, Pixmap mask,
    Pixmap alpha, int depth, Drawable d, GC gc, int src_x, int src_y,
    int src_w, int src_h, int dest_x, int dest_y);

/*
 * <pubfunc>PGraphicsCopyMvwmPicture
 * <description>
 * PGraphicsCopyMvwmPicture copies a rectangle constituted by an MvwmPicture
 ...
 * rectangle is given by the MvwmPicture p (which contains the pixmap, the
 * mask, the alpha and the depth).
 * </description>
 */
void            PGraphicsCopyMvwmPicture(Display *dpy, MvwmPicture *p,
    Drawable d, GC gc, int src_x, int src_y, int src_w, int src_h, int dest_x,
    int dest_y);
...
void            PGraphicsTileRectangle(Display *dpy, Window win,
    Pixmap pixmap, Pixmap shape, Pixmap alpha, int depth, Drawable d, GC gc,
    GC mono_gc, int src_x, int src_y, int src_w, int src_h, int dest_x,
    int dest_y, int dest_w, int dest_h);

MvwmPicture    *PGraphicsCreateStretchPicture(Display *dpy, Window win,
    MvwmPicture *src, int dest_width, int dest_height, GC gc, GC mono_gc,
    GC alpha_gc);

MvwmPicture    *PGraphicsCreateTiledPicture(Display *dpy, Window win,
    MvwmPicture *src, int dest_width, int dest_height, GC gc, GC mono_gc,
    GC alpha_gc);
...
/* never used ! */
Pixmap          PGraphicsCreateDitherPixmap(Display *dpy, Window win,
    Drawable src, Pixmap mask, int depth, GC gc, int in_width, int in_height,
