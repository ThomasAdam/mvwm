...
char           *DoPeekToken(char *indata, char **token, char *spaces,
...
char           *GetModuleResource(char *indata, char **resource,
    char *module_name);
int             GetSuffixedIntegerArguments(char *action, char **ret_action,
    int *retvals, int num, char *suffixlist, int *ret_suffixnum);
int             GetIntegerArgumentsAnyBase(char *action, char **ret_action,
    int *retvals, int num);
int             SuffixToPercentValue(int value, int suffix, int *unit_table);
int             GetIntegerArguments(char *action, char **ret_action,
    int *retvals, int num);
...
int             ParseToggleArgument(char *action, char **ret_action,
    int default_ret, char no_toggle);
