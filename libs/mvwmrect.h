 ...
 * diff_g. */
void            mvwmrect_subtract_rectangles(rectangle *rdiff, rectangle *r1,
    rectangle *r2);
/* Returns 1 is the rectangles are identical and 0 if not */
int             mvwmrect_rectangles_equal(rectangle *r1, rectangle *r2);
int             mvwmrect_move_into_rectangle(rectangle *move_rec,
    rectangle *target_rec);
int             mvwmrect_intersect_xrectangles(XRectangle * r1,
    XRectangle * r2);
